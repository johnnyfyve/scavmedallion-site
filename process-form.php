...
$headers = 'From: info@scavmedallion.com' . "\r\n" .
    'Reply-To: info@scavmedallion.com' . "\r\n" .
    'CC:johnnyfyve@gmail.com';

// *** Send email to recipients
mail('johnnyfyve@gmail.com', 'SCAVMedallion.com site contact request', $emailMessage, $headers);
